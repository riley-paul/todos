    ...
    <Drawer.Root open={isOpen} onOpenChange={setIsOpen} shouldScaleBackground>
      <Portal>
        <RadixProvider>
          ...
          <Drawer.Content className="container2 fixed bottom-0 left-0 right-0 mt-24 h-fit min-h-40 rounded-t-4 border border-b-0 bg-panel py-2 outline-none backdrop-blur">
            <Drawer.Handle />
