/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 64bf2d0b97d10bba341cda61ba21d6d7)
// Runtime types generated with workerd@1.20260424.1 2026-04-09 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/worker");
		durableNamespaces: "Sockets";
	}
	interface Env {
		ASSETS: Fetcher;
		DATABASE_URL: string;
		...
		ABLY_API_KEY: string;
		API_KEY: string;
		SOCKETS: DurableObjectNamespace<import("./src/worker").Sockets>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "DATABASE_URL" | "DATABASE_AUTH_TOKEN" | "NODE_ENV" | "SITE" | "GITHUB_CLIENT_ID" | "GITHUB_CLIENT_SECRET" | "GOOGLE_CLIENT_ID" | "GOOGLE_CLIENT_SECRET" | "ABLY_API_KEY" | "API_KEY">> {}
}
